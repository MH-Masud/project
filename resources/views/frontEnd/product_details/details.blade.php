   ...
   <div class="single">
	<div class="container">
		...
		<div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
					...
					<br>
					{!! Form::open(['method'=>'post','url'=>'/cart','class'=>'form-inline']) !!}
					...
					<div class="color-quality">
						<div class="color-quality-right">
							<h5>Quality :</h5>
							<input class="form-control" type="number" name="productQuantity" value="1">
					...
					<div class="occasion-cart">
						<button type="submit" name="submit" class="item_add hvr-outline-out button2">Add to cart</button>
					</div>
					{!! Form::close() !!}
		</div>
				<div class="clearfix"> </div>
